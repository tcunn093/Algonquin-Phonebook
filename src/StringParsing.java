	...
	public static String getNthWord(int n, String input){
		    ...
		    if (n >= 0){
		    	...
		    	while (isSpace(charArray[i]) == true){
	...
	public static String getWordsAfterString(String s, String m){
		
		String newString = s.substring(s.indexOf(m) + m.length());

		return getNWords(1, numberOfWords(newString), newString);
